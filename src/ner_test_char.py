...
def run_full_code_char(device, model_file, test_data_file, output_file, vocabulary_input_file):
	...
	test_data, test_label, test_char_data = prepare_dataset(test_data_file)
	test_dataset = CustomDataset(test_data, test_char_data, test_label)
	...
	class lstm_Model(nn.Module):
		def __init__(self, vocab_size, embedding_dim, hidden_dim, number_of_tags, total_char):
	...
	# LOAD MODEL 
	model = lstm_Model(vocab_size, 100, 100, 17, charvocabsize)
